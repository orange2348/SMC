...
/**
 * Contains TCP segment information as per the TCP specification.
 *
...
// Member methods.
    ...
    /**
     * Creates a TCP segment for the given parameters.
     * @param source_port segment is from this TCP port.
     * @param destination_address segment is destined for this
     * IP host.
     * @param destination_port segment is destined for this
     * TCP port.
     * @param sequence_number segment sequence number. Used to
     * detect missing segments.
     * @param ack_number segment is acknowledging this numbered
     * segment.
     * @param flags TCP flags (SYN, FIN, ACK, etc.)
    ...
    /**
     * Returns text containing the segment information.
     * @return TCP segment as text.
     */
    @Override
...
// Member data
    ...
    /**
     * TCP FIN bit mask is {@value}.
     */
    public static final int FIN = 0x01;

    /**
     * TCP SYN bit mask is {@value}.
     */
    public static final int SYN = 0x02;

    /**
     * TCP RST bit mask is {@value}.
     */
    public static final int RST = 0x04;

    /**
     * TCP PSH bit mask is {@value}.
     */
    public static final int PSH = 0x08;

    /**
     * TCP ACK bit mask is {@value}.
     */
    public static final int ACK = 0x10;

    /**
     * TCP URG bit mask is {@value}.
     */
    public static final int URG = 0x20;

    /**
     * TCP  FIN, ACK bit mask is {@value}.
     */
    public static final int FIN_ACK = (FIN | ACK);

    /**
     * TCP SYN, ACK bit mask is {@value}.
     */
    public static final int SYN_ACK = (SYN | ACK);

    /**
     * TCP RST, ACK bit mask is {@value}.
     */
    public static final int RST_ACK = (RST | ACK);

    /**
     * TCP PSH, ACK bit mask is {@value}.
     */
    public static final int PSH_ACK = (PSH | ACK);

    /**
     * Bit mask with all TCP flags set.
     */
