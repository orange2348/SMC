...
//
    ...
    public int compareTo(SmcAction action)
    {
        ...
        if (this != action &&
            (retval = mName.compareTo(action.getName())) == 0)
        {
            ...
            for (ait1 = mArguments.iterator(),
                     ait2 = action.mArguments.iterator();
                 ait1.hasNext() && ait2.hasNext() && retval == 0;
                )
            {
                s1 = ait1.next();
                s2 = ait2.next();
    ...
    public String toString()
    {
        ...
        {
            retval.append(" = ");
            retval.append(mArguments.get(0));
        }
        else
        {
            Iterator<String> ait;
            ...
            for (ait = mArguments.iterator(), sep = "";
                 ait.hasNext();
                 sep = ", ")
            {
                retval.append(sep);
    ...
    */
    ...
    public void setArguments(List<String> args)
        throws IllegalArgumentException
    {
        if (mPropertyFlag && (args == null || args.size() != 1))
        {
            throw (
                new IllegalArgumentException(
                    "property must have exactly one argument"));
