...
//
    ...
    {
        int retval = mName.compareTo(trans.mName);

        if (retval == 0)
        {
            retval = compareParams(trans.getParameters());
        }
    ...
    public boolean equals(final Object obj)
    {
        ...
        if (!retcode && obj instanceof SmcTransition)
        {
            ...
            retcode =
                (mName.equals(trans.mName) &&
                 compareParams(trans.mParameters) == 0);
        }
    ...
    public String toString()
    {
        ...
        final StringBuilder retval = new StringBuilder(512);
    ...
    public boolean hasCtxtReference()
    {
        ...
        for (guardIt = mGuards.iterator(), retcode = false;
             guardIt.hasNext() && !retcode;
            )
        {
    ...
    public boolean hasNonNilEndState()
    {
        ...
        {
            guard = guardIt.next();
            retcode = !guard.getEndState().equals(NIL_STATE);
        }
                         ...
                         List<SmcParameter> parameters)
    {
        ...
        if ((retval = mName.compareTo(name)) == 0)
        {
            retval = compareParams(parameters);
        }
    ...
    private int compareParams(final List<SmcParameter> params)
    {
        return (compareParams(mParameters, params));
